...
CURATED={
 ...
 "privacy.html":("Privacy statement | CorporateCareer",
   "CorporateCareer privacy statement: what data we process, on what legal basis, how long we keep it and what rights you have."),
 "voorwaarden.html":("Terms of use | CorporateCareer",
   "CorporateCareer terms of use: what the platform is and is not, how we handle vacancies and what we are not liable for."),
 "cookies.html":("Cookie statement | CorporateCareer",
   "CorporateCareer cookie statement: which cookies the site places, what they are for, how long they stay and how to refuse them."),
 ...
 "resources/dagelijks-lezen/index.html":("What to read daily: building commercial awareness | CorporateCareer",
   "Which sources to read for finance, consulting and law, how to reach them for free through your university, and how to turn an article into an answer in your interview."),
...
def page_list():
    ...
    p+=["resources/index.html","resources/sollicitatiegids/index.html","resources/case-interview/index.html","resources/finance-interview/index.html","resources/legal-interview/index.html","resources/dagelijks-lezen/index.html"]
    return sorted(set(p))
